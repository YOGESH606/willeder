...
const Nav = () => {
  ...
  const isCarouselVisible = visible ? 'show' : 'hide';
  ...
  return (
    <div className='nav'>
        <div className={isCarouselVisible}>
          <div className='overlay'>
            <div className='overlay__close' onClick={handleClick}
              >
              <IoClose />
            </div>
